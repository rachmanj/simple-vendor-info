    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('supplier-page.index') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-arrow-left"></i> Back</a>
            </div>

            <form action="{{ route('supplier-page.update', $supplier->id) }}" method="POST">
                @csrf @method('PUT')
                <div class="card-body">
...
<div class="modal fade" id="contact-create">
    ...
    <div class="modal-content">
        ...
        <form action="{{ route('supplier-page.contact.store') }}" method="POST">
        @csrf
    ...
    <div class="modal fade" id="contact-edit-{{ $contact->id }}">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('supplier-page.contact.update', $contact->id) }}" method="POST">
            @csrf @method('PUT')
            <input type="hidden" name="supplier_id" value="{{ $supplier->id }}">
            <div class="modal-body">
  ...
  <div class="modal fade" id="branch-create">
    ...
    <div class="modal-content">
        ...
        <form action="{{ route('supplier-page.branch.store') }}" method="POST">
        @csrf
        <input type="hidden" name="supplier_id" value="{{ $supplier->id }}">
        <div class="modal-body">
  ...
  <div class="modal fade" id="branch-edit-{{ $branch->id }}">
      ...
      <div class="modal-content">
          ...
          <form action="{{ route('supplier-page.branch.update', $branch->id) }}" method="POST">
          @csrf @method('PUT')
          <input type="hidden" name="supplier_id" value="{{ $supplier->id }}">
          <div class="modal-body">
