...
<div class="modal fade" id="modal-add-document">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('supplier-page.legalitas.store', $supplier->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
    ...
    <div class="modal fade" id="modal-edit-{{ $document->id }}">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="{{ route('supplier-page.legalitas.update', $document->id) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            <input type="hidden" name="supplier_id" value="{{ $supplier->id }}">
          <div class="modal-body">
