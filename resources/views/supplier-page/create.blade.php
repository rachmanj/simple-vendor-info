    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form action="{{ route('supplier-page.store') }}" method="POST">
                    @csrf
                    <div class="card-body">

                      <input type="hidden" name="reg_no" id="reg_no" value="{{ $nomor }}" class="form-control @error('reg_no') is-invalid @enderror">
                        {{-- <div class="row">
                            <div class="col-12">
